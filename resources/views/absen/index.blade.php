...
<div class="row">
    <div class="col-md-12 col-sm-12 col-12">
        <div class="info-box" style="background: linear-gradient(141.89deg,rgb(204, 23, 0) -70%,rgba(204, 23, 0, 0) 50%)no-repeat;">
            <span class="img-circle d-flex align-items-center justify-content-center mt-2" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;background-image: url('public/dev.jpeg');background-size: cover;">
            </span>
            ...
            <div class="info-box-content">
                <div style="float:left;">
                    <span class="imgtgl font-weight-bold mr-2 mt-0" style="display:inline;" id='tanggal'>First Span</span>
                    <span class="imgjam font-weight-bold mr-3 mt-0" style="display:inline;" id='jam'>Second Span</span>
                </div>
                <span class="font-size-25 font-weight-bold animate__animated animate__bounce" style="color: #cc171e">
                    FSL A.R (...)
                </span>
                <span class="info-box-number animate__animated animate__fadeInRightBig" style="margin-top:-5px">
...
<div class="row">   
    <div class="col-md-3 col-sm-6 col-6">
        <a href="{{ url('/id-card') }}">
            <div class="info-box bg-white" style="background: linear-gradient(141.89deg,rgb(254, 153, 0) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">
                ...
                <div class="info-box-content">
                    ...
                    <span class="font-size-20 font-weight-bold animate__animated animate__bounce"
        ...
        <div class="col-md-3 col-sm-6 col-6">
            <a href="{{url('/my-absen')}}">
                <div class="info-box bg-white mb-3" style="background: linear-gradient(141.89deg,rgb(71, 188, 188) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">
                    <span class="img-circle d-flex align-items-center justify-content-center bg-white" style="width: 70px;height: 70px; line-height: 70px;font-size: 35px;">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-6">
            <a href="">
                <div class="info-box bg-white" style="background: linear-gradient(141.89deg,rgb(71, 188, 188) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">
                    <span class="img-circle d-flex align-items-center justify-content-center bg-white" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="#47BCBC">
                            <path d="M29.3359 21.4062C24.2096 21.4062 20.0391 25.5768 20.0391 30.7031C20.0391 35.8295 24.2096 40 29.3359 40C34.5053 40 38.7109 35.8295 38.7109 30.7031C38.7109 25.5768 34.5053 21.4062 29.3359 21.4062ZM32.1893 29.5784L29.0643 33.3284C28.8402 33.5972 28.5095 33.75 28.1641 33.75C28.1192 33.75 28.0741 33.7474 28.0289 33.7422C27.6361 33.6966 27.2927 33.4559 27.1159 33.1022L25.8659 30.6022C25.5764 30.0234 25.8111 29.3194 26.3899 29.03C26.9687 28.7404 27.6727 28.9752 27.9622 29.5541L28.4109 30.4514L30.3888 28.0779C30.8031 27.5808 31.5421 27.5137 32.0392 27.9278C32.5365 28.3422 32.6037 29.0811 32.1893 29.5784Z"
                                fill="#47BCB" />
        ...
        <div class="col-md-3 col-sm-6 col-6">
            <a href="{{url('kib')}}">
                <div class="info-box bg-white mb-3" style="background: linear-gradient(141.89deg,rgb(241, 90, 90) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">
                    <span class="img-circle d-flex align-items-center justify-content-center bg-white" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="#F15A5A">
                            <path d="M28 0H6C5 0 4 1 4 2V38C4 39.2 5 40 6 40H34C35 40 36 39.2 36 38V8L28 0ZM14 10H16V8C16 7 17 6 18 6C19 6 20 7 20 8V10H22C23 10 24 11 24 12C24 13.2 23 14 22 14H20V16C20 17.2 19 18 18 18C17 18 16 17.2 16 16V14H14C13 14 12 13.2 12 12C12 11 13 10 14 10ZM22 34H10C9 34 8 33 8 32C8 31 9 30 10 30H22C23.2 30 24 31 24 32C24 33 23 34 22 34ZM30 26H10C9 26 8 25 8 24C8 23 9 22 10 22H30C31.2 22 32 23 32 24C32 25 31 26 30 26Z"
                                fill="#F15A5A" />
                        </svg>
                    </span>
                    <!-- <span class="info-box-icon bg-danger elevation-1">
            ...
            <a href="{{url('tib')}}">
                <div class="info-box bg-white mb-3" style="background: linear-gradient(141.89deg,rgb(119, 119, 219) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">                
                  ...
                  <i class="fa fa-user-times"></i>
                    ...
                    <span class="img-circle d-flex align-items-center justify-content-center bg-white" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="#7777DB">
                            <path d="M36.7998 0C35.1998 0 33.7998 1.4 33.7998 3V6H39.7998V3C39.7998 1.4 38.5998 0 36.7998 0Z"
                                fill="#7777DB" />
        ...
        <div class="col-md-3 col-sm-6 col-6">
            <a href="{{url('my-division')}}">
                 <div class="info-box bg-white mb-3" style="background: linear-gradient(141.89deg,rgb(254, 153, 0) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">                
                    <span class="img-circle d-flex align-items-center justify-content-center bg-white" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="#FE9900">
                            <path d="M24.6875 2.34375H23.3154C22.8313 0.979609 21.5278 0 20 0C18.4722 0 17.1688 0.979609 16.6846 2.34375H15.3125C13.3739 2.34375 11.7969 3.92078 11.7969 5.85938C11.7969 6.50711 12.321 7.03125 12.9688 7.03125H27.0312C27.679 7.03125 28.2031 6.50711 28.2031 5.85938C28.2031 3.92078 26.6261 2.34375 24.6875 2.34375Z"
                                fill="#FE9900" />
                  ...
                  <i class="fa fa-user-plus"></i>
                    ...
                    <div class="info-box-content">
                        <!-- <span class="info-box-text text-warning">Total User Korkab</span> -->
                        <span class="font-size-20 font-weight-bold animate__animated animate__fadeInRightBig" 
                            style="color: rgb(254, 153, 0)">
                            My Division
                        </span>
                    </div>

...
<div class="row">
    <div class="col-md-12 col-sm-12 col-12">
        <div class="info-box" style="background: linear-gradient(141.89deg,rgb(204, 23, 0) -70%,rgba(204, 23, 0, 0) 50%)no-repeat;">
            <span class="img-circle d-flex align-items-center justify-content-center" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;background-image: url('public/dev.jpeg');background-size: cover;">
            </span>
...
<div class="row">   
    <div class="col-md-3 col-sm-6 col-6">
        <div class="info-box bg-white" style="background: linear-gradient(141.89deg,rgb(254, 153, 0) -70%,rgba(254, 153, 0, 0) 50%)no-repeat;">
            <span class="img-circled-flex align-items-center justify-content-center bg-white" style="width: 70px;height: 70px;line-height: 70px;font-size: 35px;">
